export const defaultMetadata = {
  ...
  keywords: {
    ...
    fr: "architecture, conception architecturale, construction, urbanisme, solutions innovantes, architecture durable, design moderne, design d'intérieur, gestion de projet, architecture marocaine, architecture africaine, architecture du Moyen-Orient, architecture européenne, conception de bâtiments, projets résidentiels, projets commerciaux, bâtiments culturels, architecture de luxe, architecture contemporaine",
    ar: "هندسة معمارية، تصميم معماري، بناء، تخطيط عمراني، حلول مبتكرة، عمارة مستدامة، تصميم حديث، تصميم داخلي، إدارة مشاريع، عمارة مغربية، عمارة إفريقية، عمارة شرق أوسطية، عمارة أوروبية، تصميم المباني، مشاريع سكنية، مشاريع تجارية، مباني ثقافية، هندسة معمارية فاخرة، عمارة معاصرة",
  },
};
